...
class mainCog(commands.Cog): 
	...
	@commands.command(name='!타우티')
	async def Tauti1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/타우티.mp3')

	@commands.command(name='!타우티탐')
	async def Tauti2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/타우티.mp3')
	...
	async def test_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/테스트.mp3')

	@commands.command(name='!점검')
	async def check1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/봇점검중.mp3')

	@commands.command(name='!점검중')
	async def check2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/봇점검중.mp3')

	@commands.command(name='!봇점검')
	async def check3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/봇점검중.mp3')

	@commands.command(name='!봇점검중')
	async def check4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/봇점검중.mp3')

	@commands.command(name='!점검완료')
	async def check5_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/봇점검완료.mp3')

	@commands.command(name='!봇점검완료')
	async def check6_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/봇점검완료.mp3')

	@commands.command(name='!봇업데이트중')
	async def update01_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/봇점검중.mp3')

	@commands.command(name='!이벤트')
	async def event_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/이벤트.mp3')

	@commands.command(name='!전투')
	async def BattleHelp_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/BattleHelp.mp3')

	@commands.command(name='!전투지원')
	async def BattleHelp2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/BattleHelp.mp3')

	@commands.command(name='!본토지원')
	async def War1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/본토쟁지원.mp3')

	@commands.command(name='!월드지원')
	async def War2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/월드쟁지원.mp3')

	@commands.command(name='!지원')
	async def War3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/적지원.mp3')

	@commands.command(name='!안녕하세요')
	async def hello1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/hello1.mp3')

	@commands.command(name='!안녕하세요2')
	async def hello2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/hello2.mp3')

	@commands.command(name='!보스지원')
	async def BoosHelp_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/BoosHelp.mp3')

	@commands.command(name='!스파인')
	async def Spine1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/스파인탐.mp3')

	@commands.command(name='!스파인탐')
	async def Spine2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/스파인탐.mp3')

	@commands.command(name='!스파인분쟁지대')
	async def Spine3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/스파인탐.mp3')

	@commands.command(name='!스파인분쟁지대탐')
	async def Spine4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/스파인탐.mp3')

	@commands.command(name='!네크로')
	async def Necropolis1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/네크로탐.mp3')

	@commands.command(name='!네크로탐')
	async def Necropolis2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/네크로탐.mp3')

	@commands.command(name='!네크로폴리스')
	async def Necropolis3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/네크로탐.mp3')

	@commands.command(name='!네크로폴리스탐')
	async def Necropolis4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/네크로탐.mp3')

	@commands.command(name='!각성')
	async def StrongIsland1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/각성탐.mp3')

	@commands.command(name='!각성탐')
	async def StrongIsland2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/각성탐.mp3')

	@commands.command(name='!각성의섬')
	async def StrongIsland3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/각성탐.mp3')

	@commands.command(name='!각성의섬탐')
	async def StrongIsland4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/각성탐.mp3')

	@commands.command(name='!보스')
	async def BoosJen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/BoosJen.mp3')

	@commands.command(name='!보스젠')
	async def BoosJen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/BoosJen.mp3')

	@commands.command(name='!오만')
	async def dhamsnxka_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오만탐.mp3')

	@commands.command(name='!오만탐')
	async def dhamsnxkatam_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오만탐.mp3')

	@commands.command(name='!베오라')
	async def beora_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라탐.mp3')

	@commands.command(name='!베오라탐')
	async def beoratam_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라탐.mp3')

	@commands.command(name='!자켄')
	async def Jaken01_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/자켄.mp3')

	@commands.command(name='!자켄탐')
	async def Jaken02_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/자켄.mp3')

	@commands.command(name='!바이움')
	async def baium01_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/바이움.mp3')

	@commands.command(name='!바이움탐')
	async def baium02_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/바이움.mp3')

	@commands.command(name='!균열')
	async def HorseLook1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/균열.mp3')

	@commands.command(name='!균열탐')
	async def HorseLook2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/균열.mp3')

	@commands.command(name='!말룩')
	async def HorseLook3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/말룩.mp3')

	@commands.command(name='!말룩탐')
	async def HorseLook4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/말룩.mp3')

	@commands.command(name='!월보')
	async def wolbotam1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/월보.mp3')

	@commands.command(name='!월보탐')
	async def wolbotam2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/월보.mp3')

	@commands.command(name='!카타콤')
	async def Catacombs1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카타콤.mp3')

	@commands.command(name='!카타콤탐')
	async def Catacombstam2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카타콤.mp3')

	@commands.command(name='!혈맹카타콤')
	async def Catacombs3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹카타콤탐.mp3')

	@commands.command(name='!혈맹카타콤탐')
	async def Catacombstam4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹카타콤탐.mp3')

	@commands.command(name='!혈맹레이드')
	async def BMS1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹레이드젠.mp3')

	@commands.command(name='!혈맹레이드탐')
	async def BMStam2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹레이드젠.mp3')

	@commands.command(name='!혈레')
	async def BMS3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹레이드젠.mp3')

	@commands.command(name='!혈레탐')
	async def BMStam4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹레이드젠.mp3')

	@commands.command(name='!혈맹향로')
	async def Blood_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹향로.mp3')

	@commands.command(name='!혈맹향로탐')
	async def Bloodtam_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/혈맹향로.mp3')

	@commands.command(name='!향로')
	async def Scented_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/향로.mp3')

	@commands.command(name='!향로탐')
	async def Scentedtam_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/향로.mp3')

	@commands.command(name='!파던')
	async def PartyDungeon1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/파던.mp3')

	@commands.command(name='!파던탐')
	async def PartyDungeontam2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/파던.mp3')

	@commands.command(name='!파티던전')
	async def PartyDungeon3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/파던.mp3')

	@commands.command(name='!파티던전탐')
	async def PartyDungeontam4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/파던.mp3')

	@commands.command(name='!고대섬집합')
	async def ancientislandset_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/고대섭집합.mp3')

	@commands.command(name='!베오라집합')
	async def veoraset_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라집합.mp3')

	@commands.command(name='!아지트집합')
	async def setofhideouts_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/아지트집합.mp3')

	@commands.command(name='!악마섬집합')
	async def setofevilislands_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/악섬집합.mp3')

	@commands.command(name='!영불기억집합')
	async def eternalmemoryset_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/영불기억집합.mp3')

	@commands.command(name='!오만집합')
	async def arrogantset_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오만집합.mp3')

	@commands.command(name='!제파르집합')
	async def zephyrset_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/제파르집합.mp3')
	
	@commands.command(name='!악마섬')
	async def Devil1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/악마섬탐.mp3')
	
	@commands.command(name='!악마섬탐')
	async def Deviltam2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/악마섬탐.mp3')
	
	@commands.command(name='!고대섬')
	async def ancient1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/고대섬탐.mp3')
	
	@commands.command(name='!고대섬탐')
	async def ancienttam2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/고대섬탐.mp3')
	
	@commands.command(name='!쿠스토르')
	async def Custor1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/고대섬탐.mp3')
	
	@commands.command(name='!쿠스토르탐')
	async def Custor2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/고대섬탐.mp3')

	@commands.command(name='!제파르')
	async def Zephyr1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/제파르탐.mp3')
	
	@commands.command(name='!제파르탐')
	async def Zephyr2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/제파르탐.mp3')
		
	@commands.command(name='!하르나크')
	async def harnak1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/제파르탐.mp3')
		
	@commands.command(name='!하르나크탐')
	async def harnak2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/제파르탐.mp3')
		
	@commands.command(name='!그레시아')
	async def gracia1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/그레시아탐.mp3')

	@commands.command(name='!그레시아탐')
	async def gracia2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/그레시아탐.mp3')

	@commands.command(name='!아딜')
	async def Adil1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/아딜.mp3')

	@commands.command(name='!아딜탐')
	async def Adil2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/아딜.mp3')

	@commands.command(name='!이포스')
	async def ifos1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/이포스.mp3')

	@commands.command(name='!이포스탐')
	async def ifos2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/이포스.mp3')

	@commands.command(name='!케두두')
	async def kedudu1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/케두두.mp3')

	@commands.command(name='!케두두탐')
	async def kedudu2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/케두두.mp3')

	@commands.command(name='!갈락시아')
	async def galaxia1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/갈락시아.mp3')

	@commands.command(name='!갈락시아탐')
	async def galaxia2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/갈락시아.mp3')

	@commands.command(name='!베리타스')
	async def Veritas1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베리타스.mp3')

	@commands.command(name='!베리타스탐')
	async def Veritas2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베리타스.mp3')

	@commands.command(name='!이그니스')
	async def Ignis1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/이그니스.mp3')

	@commands.command(name='!이그니스탐')
	async def Ignis2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/이그니스.mp3')

	@commands.command(name='!광기슈리엘')
	async def MadShrile1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기슈리엘.mp3')
	
	@commands.command(name='!광기슈리엘젠')
	async def MadShrilejen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기슈리엘.mp3')
	
	@commands.command(name='!광기개미')
	async def Madant1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기개미.mp3')
	
	@commands.command(name='!광기개미젠')
	async def Madantjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기개미.mp3')
	
	@commands.command(name='!광기드비')
	async def MadDragon1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기드비.mp3')
	
	@commands.command(name='!광기드비젠')
	async def MadDragonjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기드비.mp3')
		
	@commands.command(name='!1층광기')
	async def MadRamdal1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기람달.mp3')
	
	@commands.command(name='!광기람달')
	async def MadRamdaljen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기람달.mp3')
		
	@commands.command(name='!광기람달젠')
	async def MadRamdaljen3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기람달.mp3')
		
	@commands.command(name='!2층광기')
	async def MadMardil1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기마르딜.mp3')
	
	@commands.command(name='!광기마르딜')
	async def MadMardiljen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기마르딜.mp3')
	
	@commands.command(name='!광기마르딜젠')
	async def MadMardiljen3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기마르딜.mp3')
	
	@commands.command(name='!3층광기')
	async def MadKernon1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기케르논.mp3')
	
	@commands.command(name='!광기케르논')
	async def MadKernonjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기케르논.mp3')
	
	@commands.command(name='!광기케르논젠')
	async def MadKernonjen3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기케르논.mp3')

	@commands.command(name='!4층광기')
	async def MadTarim1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기타림.mp3')

	@commands.command(name='!광기타림')
	async def MadTarimjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기타림.mp3')

	@commands.command(name='!광기타림젠')
	async def MadTarimjen3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기타림.mp3')

	@commands.command(name='!5층광기')
	async def MadHallat1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기할라트.mp3')

	@commands.command(name='!광기할라트')
	async def MadHallatjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기할라트.mp3')

	@commands.command(name='!광기할라트젠')
	async def MadHallatjen3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기할라트.mp3')

	@commands.command(name='!6층광기')
	async def MadBella1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기벨라.mp3')

	@commands.command(name='!광기벨라')
	async def MadBella2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기벨라.mp3')

	@commands.command(name='!광기벨라젠')
	async def MadBellajen3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기벨라.mp3')

	@commands.command(name='!광기셀리호든')
	async def MadSally1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기셀리호든.mp3')

	@commands.command(name='!광기셀리호든젠')
	async def MadSallyjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기셀리호든.mp3')

	@commands.command(name='!광기코어')
	async def Madcore1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기코어.mp3')

	@commands.command(name='!광기코어젠')
	async def Madcorejen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기코어.mp3')

	@commands.command(name='!광기크루마')
	async def MadCruma1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기크루마.mp3')

	@commands.command(name='!광기크루마젠')
	async def MadCrumajen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기크루마.mp3')

	@commands.command(name='!광기피닉스')
	async def MadPhoenix1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기피닉스.mp3')

	@commands.command(name='!광기피닉스젠')
	async def MadPhoenixjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기피닉스.mp3')

	@commands.command(name='!본토보스')
	async def mainlandboss1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/본토보스.mp3')

	@commands.command(name='!본토보스젠')
	async def mainlandbossjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/본토보스.mp3')

	@commands.command(name='!보스젠예정')
	async def bosegenscheduled1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/보스젠예정.mp3')

	@commands.command(name='!광기보스')
	async def BoosGangi000_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/Madnessboss.mp3')

	@commands.command(name='!광기보스젠')
	async def BoosGangijen000_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/Madnessboss.mp3')
	
	@commands.command(name='!광기보스불')
	async def madnessbossbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기보스불.mp3')
	
	@commands.command(name='!광기피닉스불')
	async def madnessphoenixbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기피닉스불.mp3')

	@commands.command(name='!광기개미불')
	async def madantbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기개미불.mp3')

	@commands.command(name='!광기드비불')
	async def maddragonbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기드비불.mp3')

	@commands.command(name='!광기코어불')
	async def madcorebull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기코어불.mp3')

	@commands.command(name='!광기크루마불')
	async def MadCrumarbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기크루마불.mp3')

	@commands.command(name='!광기노르무스')
	async def MadNormusgen0_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기노르무스젠.mp3')

	@commands.command(name='!광기노르무스젠')
	async def MadNormusgen1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기노르무스젠.mp3')

	@commands.command(name='!광기노르무스지원')
	async def MadNormusgen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기노르무스지원.mp3')

	@commands.command(name='!광기무프')
	async def Madmove0_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기무프젠.mp3')

	@commands.command(name='!광기무프젠')
	async def Madmove1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기무프젠.mp3')

	@commands.command(name='!광기무프지원')
	async def Madmove2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기무프지원.mp3')

	@commands.command(name='!광기실라')
	async def Madness0_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기실라젠.mp3')

	@commands.command(name='!광기실라젠')
	async def Madness1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기실라젠.mp3')

	@commands.command(name='!광기실라지원')
	async def Madness2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기실라지원.mp3')

	@commands.command(name='!광기우칸바')
	async def MadUkanbagen0_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기우칸바젠.mp3')

	@commands.command(name='!광기우칸바젠')
	async def MadUkanbagen1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기우칸바젠.mp3')

	@commands.command(name='!광기우칸바지원')
	async def MadUkanbagen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기우칸바지원.mp3')

	@commands.command(name='!베오라광기')
	async def veoramadbosszen1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라광기보스젠.mp3')

	@commands.command(name='!베오라광기보스젠')
	async def veoramadbosszen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라광기보스젠.mp3')

	@commands.command(name='!베오라광기보스지원')
	async def veoramadbosssupport1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라광기보스지원.mp3')

	@commands.command(name='!베오라보스')
	async def veorabosssen1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라보스젠.mp3')

	@commands.command(name='!베오라보스젠')
	async def veorabosssen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라보스젠.mp3')

	@commands.command(name='!베오라보스지원')
	async def veorabosssupport1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베오라보스지원.mp3')
	
	@commands.command(name='!피닉스불')
	async def phoenixlightbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/피닉스불.mp3')

	@commands.command(name='!크루마불')
	async def chromabull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/크루마불.mp3')

	@commands.command(name='!드비불')
	async def dragonlightbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/드비불.mp3')

	@commands.command(name='!코어불')
	async def corelightbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/코어불.mp3')

	@commands.command(name='!개미불')
	async def antlightbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/개미불.mp3')

	@commands.command(name='!올크스불')
	async def olxlightbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/올크스불.mp3')

	@commands.command(name='!광기올크스불')
	async def guanggiolxlightbull2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기올크스불.mp3')

	@commands.command(name='!광기오르펜불')
	async def guanggiOrpenbull2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기오르펜불.mp3')

	@commands.command(name='!라하불')
	async def lahalightbull_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/라하불.mp3')

	@commands.command(name='!슈리엘')
	async def Shriel_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/슈리엘.mp3')

	@commands.command(name='!슈리엘젠')
	async def Shrieljen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/슈리엘.mp3')

	@commands.command(name='!솔라리스')
	async def Solaris01_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/솔라리스.mp3')

	@commands.command(name='!솔라리스젠')
	async def Solaris02_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/솔라리스.mp3')

	@commands.command(name='!노르무스')
	async def Normus_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/노르무스.mp3')

	@commands.command(name='!노르무스젠')
	async def Normusjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/노르무스.mp3')

	@commands.command(name='!무프')
	async def Moof_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/무프.mp3')

	@commands.command(name='!무프젠')
	async def Moofjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/무프.mp3')

	@commands.command(name='!실라')
	async def Squill_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/실라.mp3')

	@commands.command(name='!실라젠')
	async def Squilljen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/실라.mp3')

	@commands.command(name='!우칸바')
	async def Ukanba_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/우칸바.mp3')

	@commands.command(name='!우칸바젠')
	async def Ukanbajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/우칸바.mp3')

	@commands.command(name='!광기올크스')
	async def guanggiolxlightbull23_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기올크스.mp3')

	@commands.command(name='!광기오르펜')
	async def guanggiOrpenbull23_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기오르펜.mp3')

	@commands.command(name='!광기올크스젠')
	async def guanggiolxlightbull234_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기올크스.mp3')

	@commands.command(name='!광기오르펜젠')
	async def guanggiOrpenbull234_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/광기오르펜.mp3')

	@commands.command(name='!가레스')
	async def Gareth_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/가레스.mp3')

	@commands.command(name='!가레스젠')
	async def Garethjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/가레스.mp3')

	@commands.command(name='!글라키')
	async def Glaky_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/글라키.mp3')

	@commands.command(name='!글라키젠')
	async def Glakyjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/글라키.mp3')

	@commands.command(name='!크루마')
	async def Cruma1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/크루마.mp3')

	@commands.command(name='!크루마젠')
	async def Crumajen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/크루마.mp3')

	@commands.command(name='!돌크')
	async def Cruma3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/크루마.mp3')

	@commands.command(name='!돌크젠')
	async def Crumajen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/크루마.mp3')

	@commands.command(name='!돌연변크루마')
	async def Cruma5_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/크루마.mp3')

	@commands.command(name='!돌연변크루마젠')
	async def Crumajen6_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/크루마.mp3')

	@commands.command(name='!드비')
	async def Dargon_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/드비.mp3')

	@commands.command(name='!드비젠')
	async def Dargonjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/드비.mp3')

	@commands.command(name='!라하')
	async def Laha_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/라하.mp3')

	@commands.command(name='!라하젠')
	async def Lahajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/라하.mp3')

	@commands.command(name='!란도르')
	async def Randor_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/란도르.mp3')

	@commands.command(name='!란도르젠')
	async def Randojenr_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/란도르.mp3')

	@commands.command(name='!레피로')
	async def Lepiro_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/레피로.mp3')

	@commands.command(name='!레피로젠')
	async def Lepirojen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/레피로.mp3')

	@commands.command(name='!마투라')
	async def Mathura_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/마투라.mp3')

	@commands.command(name='!마투라젠')
	async def Mathurajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/마투라.mp3')

	@commands.command(name='!망각')
	async def oblivion1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/망각.mp3')

	@commands.command(name='!망각젠')
	async def oblivionjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/망각.mp3')

	@commands.command(name='!거울')
	async def oblivion3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/망각.mp3')

	@commands.command(name='!거울젠')
	async def oblivionjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/망각.mp3')

	@commands.command(name='!망각거울')
	async def oblivion5_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/망각.mp3')

	@commands.command(name='!망각거울젠')
	async def oblivionjen6_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/망각.mp3')

	@commands.command(name='!메두사')
	async def medusa_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/메두사.mp3')

	@commands.command(name='!메두사젠')
	async def medusajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/메두사.mp3')

	@commands.command(name='!바실라')
	async def Basila_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/바실라.mp3')

	@commands.command(name='!바실라젠')
	async def Basilajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/바실라.mp3')

	@commands.command(name='!발보')
	async def Balbo_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/발보.mp3')

	@commands.command(name='!발보젠')
	async def Balbojen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/발보.mp3')

	@commands.command(name='!베히')
	async def Behe1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베히.mp3')

	@commands.command(name='!베히젠')
	async def Behejen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베히.mp3')

	@commands.command(name='!베히모스')
	async def Behe3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베히.mp3')

	@commands.command(name='!베히모스젠')
	async def Behejen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/베히.mp3')

	@commands.command(name='!브래카')
	async def bracka_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/브래카.mp3')

	@commands.command(name='!브래카젠')
	async def brackajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/브래카.mp3')

	@commands.command(name='!릴리')
	async def lily1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/릴리.mp3')

	@commands.command(name='!릴리젠')
	async def lilyjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/릴리.mp3')

	@commands.command(name='!블랙릴리')
	async def lily3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/릴리.mp3')

	@commands.command(name='!블랙릴리젠')
	async def lilyjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/릴리.mp3')

	@commands.command(name='!사르카')
	async def Sarka_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/사르카.mp3')

	@commands.command(name='!사르카젠')
	async def Sarkajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/사르카.mp3')

	@commands.command(name='!사무엘')
	async def Samuel_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/사무엘.mp3')

	@commands.command(name='!사무엘젠')
	async def Samueljen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/사무엘.mp3')

	@commands.command(name='!사반')
	async def sabannah_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/사반.mp3')

	@commands.command(name='!사반젠')
	async def sabannahjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/사반.mp3')

	@commands.command(name='!셀루')
	async def Cellu_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/셀루.mp3')

	@commands.command(name='!셀루젠')
	async def Cellujen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/셀루.mp3')

	@commands.command(name='!스탄')
	async def stan_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/스탄.mp3')

	@commands.command(name='!스탄젠')
	async def stanjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/스탄.mp3')

	@commands.command(name='!안드')
	async def and1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/안드.mp3')

	@commands.command(name='!안드젠')
	async def andjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/안드.mp3')

	@commands.command(name='!안드라스')
	async def and3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/안드.mp3')

	@commands.command(name='!안드라스젠')
	async def andjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/안드.mp3')

	@commands.command(name='!엔쿠라')
	async def Enkura_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/엔쿠라.mp3')

	@commands.command(name='!엔쿠라젠')
	async def Enkurajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/엔쿠라.mp3')

	@commands.command(name='!개미')
	async def Ant3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/개미.mp3')

	@commands.command(name='!개미젠')
	async def Antjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/개미.mp3')

	@commands.command(name='!여왕개미')
	async def Ant5_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/개미.mp3')

	@commands.command(name='!여왕개미젠')
	async def Antjen6_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/개미.mp3')

	@commands.command(name='!오르펜불')
	async def Orpen12_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오르펜불.mp3')

	@commands.command(name='!오르펜')
	async def Orpen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오르펜.mp3')

	@commands.command(name='!오르펜젠')
	async def Orpenjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오르펜.mp3')

	@commands.command(name='!오크')
	async def Oak1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오크.mp3')

	@commands.command(name='!오크젠')
	async def Oakjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오크.mp3')

	@commands.command(name='!오염크루마')
	async def Oak3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오크.mp3')

	@commands.command(name='!오크염크루마젠')
	async def Oakjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/오크.mp3')

	@commands.command(name='!올크스')
	async def Olks_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/올크스.mp3')

	@commands.command(name='!올크스젠')
	async def Olksjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/올크스.mp3')

	@commands.command(name='!체르')
	async def cher1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/체르.mp3')

	@commands.command(name='!체르젠')
	async def cherjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/체르.mp3')

	@commands.command(name='!체르투바')
	async def cher3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/체르.mp3')

	@commands.command(name='!체르투바젠')
	async def cherjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/체르.mp3')

	@commands.command(name='!카브')
	async def carb1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카브.mp3')

	@commands.command(name='!카브젠')
	async def carbjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카브.mp3')

	@commands.command(name='!카브리오')
	async def carb3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카브.mp3')

	@commands.command(name='!카브리오젠')
	async def carbjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카브.mp3')

	@commands.command(name='!카탄')
	async def Catan_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카탄.mp3')

	@commands.command(name='!카탄젠')
	async def Catanjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/카탄.mp3')

	@commands.command(name='!켈소스')
	async def Kelsos_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/켈소스.mp3')

	@commands.command(name='!켈소스젠')
	async def Kelsosjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/켈소스.mp3')

	@commands.command(name='!코룬')
	async def korun_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/코룬.mp3')

	@commands.command(name='!코룬젠')
	async def korunjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/코룬.mp3')

	@commands.command(name='!코어')
	async def Core_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/코어.mp3')

	@commands.command(name='!코어젠')
	async def Corejen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/코어.mp3')

	@commands.command(name='!타나')
	async def Tana1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/타나.mp3')

	@commands.command(name='!타나젠')
	async def Tanajen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/타나.mp3')

	@commands.command(name='!타나토스')
	async def Tana3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/타나.mp3')

	@commands.command(name='!타나토스젠')
	async def Tanajen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/타나.mp3')

	@commands.command(name='!탈라킨')
	async def Talakin_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/탈라킨.mp3')

	@commands.command(name='!탈라킨젠')
	async def Talakinjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/탈라킨.mp3')

	@commands.command(name='!탈킨')
	async def Tallkin_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/탈킨.mp3')

	@commands.command(name='!탈킨젠')
	async def Tallkinjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/탈킨.mp3')

	@commands.command(name='!템페')
	async def tempeh1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/템페.mp3')

	@commands.command(name='!템페젠')
	async def tempehjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/템페.mp3')

	@commands.command(name='!템페스트')
	async def tempeh3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/템페.mp3')

	@commands.command(name='!템페스트젠')
	async def tempehjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/템페.mp3')

	@commands.command(name='!트롬바')
	async def Tromba_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/트롬바.mp3')

	@commands.command(name='!트롬바젠')
	async def Trombajen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/트롬바.mp3')

	@commands.command(name='!티미니엘')
	async def Timiel_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/티미니엘.mp3')

	@commands.command(name='!티미니엘젠')
	async def Timieljen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/티미니엘.mp3')

	@commands.command(name='!티미트리스')
	async def Timithris_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/티미트리스.mp3')

	@commands.command(name='!티미트리스젠')
	async def Timithrisjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/티미트리스.mp3')

	@commands.command(name='!판나')
	async def panna1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판나.mp3')

	@commands.command(name='!판나젠')
	async def pannajen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판나.mp3')

	@commands.command(name='!판나로드')
	async def panna3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판나.mp3')

	@commands.command(name='!판나로드젠')
	async def pannajen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판나.mp3')

	@commands.command(name='!판드')
	async def pand1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판드.mp3')

	@commands.command(name='!판드젠')
	async def pandjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판드.mp3')

	@commands.command(name='!판드라이드')
	async def pand3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판드.mp3')

	@commands.command(name='!판드라이드젠')
	async def pandjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/판드.mp3')

	@commands.command(name='!펠리스')
	async def Palace_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/펠리스.mp3')

	@commands.command(name='!펠리스젠')
	async def Palacejen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/펠리스.mp3')

	@commands.command(name='!플린트')
	async def flint_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/플린트.mp3')

	@commands.command(name='!플린트젠')
	async def flintjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/플린트.mp3')

	@commands.command(name='!피닉스')
	async def pinix_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/피닉스.mp3')

	@commands.command(name='!피닉스젠')
	async def pinixjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/피닉스.mp3')

	@commands.command(name='!하프')
	async def harp_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/하프.mp3')

	@commands.command(name='!하프젠')
	async def harpjen_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/하프.mp3')

	@commands.command(name='!히실')
	async def Hisy1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/히실.mp3')

	@commands.command(name='!히실젠')
	async def Hisyjen2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/히실.mp3')

	@commands.command(name='!히실로메')
	async def Hisy3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/히실.mp3')

	@commands.command(name='!히실로메젠')
	async def Hisyjen4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/히실.mp3')

	@commands.command(name='!나이아스')
	async def Nias1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/나이아스.mp3')
	
	@commands.command(name='!나이아스젠')
	async def Nias2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/나이아스.mp3')
	
	@commands.command(name='!아스')
	async def Nias3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/나이아스.mp3')
	
	@commands.command(name='!아스젠')
	async def Nias4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/나이아스.mp3')
	
	@commands.command(name='!나이아스불')
	async def Nias5_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/나이아스불.mp3')
	
	@commands.command(name='!아스불')
	async def Nias6_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/나이아스불.mp3')
	
	@commands.command(name='!모데우스')
	async def Modeus1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/모데우스.mp3')
	
	@commands.command(name='!모데우스젠')
	async def Modeus2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/모데우스.mp3')
	
	@commands.command(name='!우스')
	async def Modeus3_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/모데우스.mp3')
	
	@commands.command(name='!우스젠')
	async def Modeus4_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/모데우스.mp3')
	
	@commands.command(name='!모데우스불')
	async def Modeus5_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/모데우스불.mp3')
	
	@commands.command(name='!우스불')
	async def Modeus6_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/모데우스불.mp3')
	
	@commands.command(name='!각성보스')
	async def gaksung1_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/각성보스.mp3')

	@commands.command(name='!각성보스젠')
	async def gaksung2_(self, ctx):
		if basicSetting[21] != "1":
			return await ctx.send('```보이스를 사용하지 않도록 설정되어 있습니다.```', tts=False)
		return await PlaySound(ctx.voice_client, './sound/각성보스.mp3')
